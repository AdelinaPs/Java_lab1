...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Вывод дробной части: " + "%.2f%n", n.fraction(x)); // только 2 знака после запятой
    ...
    public boolean isInRange() {
        ...
        System.out.println("Правая граница диапазона(b) = " + b);
    ...
    public boolean isEqual() {
        ...
        System.out.println("3-е число: " + c);
        if (a == b && b == c) {
            return true;
        }
        return false;
    ...
    public void square(){
        Scanner scan = new Scanner(System.in);
        System.out.print("Введите число для квадрата: ");
        int x = scan.nextInt();
        for (int i = 0; i < x; i++) {
            for (int j = 0; j < x; j++) {
                System.out.print("*");
